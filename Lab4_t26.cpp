...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("F:/Content/box.obj")) {
            return false;
        }
        ...
        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "F:/Content/normal_up.jpg");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "4th Lab CG")) {
        return 1;
    }
